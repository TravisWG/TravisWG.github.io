...
var HTMLgithub = '<li class="flex-item"><span class="orange-text">github:</span><span class="white-text"><a href="%link%" id="github">%data%</a></span></li>';
...
function initializeMap() {
  ...
  */
  function locationFinder() {
    ...
    controller.getEducationData().schools.forEach(function(school){
    ...
    // as described in the Udacity FEND Style Guide:
    // https://udacity.github.io/frontend-nanodegree-styleguide/javascript.html#for-in-loop
    controller.getWorkData().forEach(function(job){
